		...
		<div className="relative">
			...
			<div className="block md:hidden border-b">
				<button
					...
					onClick={toggle}
					className="flex  items-center justify-between py-3 w-full uppercase text-lg md:text-base font-semibold"
				>
					...
					<motion.svg
						...
						viewBox="0 0 20 20"
					>
						<path d="M7.21 14.77a.75.75 0 01.02-1.06L10.94 10 7.23 6.35a.75.75 0 111.06-1.06l4.25 4.24a.75.75 0 010 1.06l-4.25 4.24a.75.75 0 01-1.06-.02z" />
					</motion.svg>
				</button>
			...
			{/* DESKTOP */}
			<motion.div
				className="hidden md:flex items-center gap-1 relative uppercase text-lg font-semibold tracking-[0.05em] cursor-pointer"
					...
					{isOpen && (
						...
						>
							{(item.children ?? []).map((child, i) => (
								<div
									key={i}
									className="px-4 py-2 hover:bg-gray-100 cursor-pointer text-black hover:text-[var(--main)] transition-colors duration-300"
								>
									{child}
								</div>
							))}
